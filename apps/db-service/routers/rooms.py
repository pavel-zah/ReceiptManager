...
def add_participant(room_id: str, user_id: str, db: Session = Depends(get_db)):
...
def remove_participant(room_id: str, user_id: str, db: Session = Depends(get_db)):
